...
> Otevřít tuto stránku v aplikaci [https://petrhonzejk.github.io/pxt-robocar-empty/](https://petrhonzejk.github.io/pxt-robocar-empty/)
...
* klikněte na možnost **Nový projekt**
* klikněte na možnost **Rozšíření** v nabídce s ozubeným kolem
* vyhledat **https://github.com/petrhonzejk/pxt-robocar-empty** a importovat

## Upravit tento projekt ![Odznak stavu sestavení](https://github.com/petrhonzejk/pxt-robocar-empty/workflows/MakeCode/badge.svg)

Slouží k úpravě tohoto úložiště v aplikaci MakeCode.

* otevřít [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klikněte na možnost **Import** a poté na **Import adresy URL**
* vložte **https://github.com/petrhonzejk/pxt-robocar-empty** a klikněte na možnost import
...
![Vykreslený náhled bloků](https://github.com/petrhonzejk/pxt-robocar-empty/raw/master/.github/makecode/blocks.png)
